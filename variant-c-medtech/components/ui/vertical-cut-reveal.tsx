...
import { type AnimationOptions, motion, useReducedMotion } from "framer-motion";
...
/**
 * Reveals text by sliding each word/character up from a clipped container.
 * Honors prefers-reduced-motion (renders the text statically).
 */
